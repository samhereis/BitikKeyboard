     ...
     class Transcrptiber_Old {
         constructor(){
             this._transcriptionList = [
                 ...
                 new TranscriptionEntry("ұ", "𐰩", "𐰩", CharacterType.HardVowel),
                 ...
                 new TranscriptionEntry("ū", "𐰩", "𐰩", CharacterType.HardVowel),
                 new TranscriptionEntry("i", "𐰄", "𐰄", CharacterType.SoftVowel),
                 new TranscriptionEntry("İ", "𐰄", "𐰄", CharacterType.SoftVowel),
                 ...
                 new TranscriptionEntry("ۇ", "𐰩", "𐰩", CharacterType.HardVowel),
